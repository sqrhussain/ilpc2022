...
from baselinemodels import BaselineNetworkX,BaselineConstant
...
def main(
    ...
    model = BaselineNetworkX(triples_factory=dataset.transductive_training,
        inference_factory=dataset.inductive_inference,prediction_model=nx.adamic_adar_index)
    print(model.device)
